...
@JsonDeserialize(builder = DeleteCharacterRequest.Builder.class)
public class DeleteCharacterRequest {
    ...
    public DeleteCharacterRequest(String username, String characterName, String characterClass, String spec, String role, String race, String publicNote, String officerNote, String professionOne, String professionTwo, Boolean alternateCharacter, Set<String> wishList) {
    ...
    public static class Builder {
        ...
        public DeleteCharacterRequest build() {
            return new DeleteCharacterRequest(username, characterName, characterClass, spec, role, race, publicNote, officerNote, professionOne, professionTwo, alternateCharacter, wishList);
        }
    }
}
